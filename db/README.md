...
Схема БД `ebay_to_buy@194.164.245.107:5406`. Спецификация — `../purchase-logic.yaml`, план — `../IMPLEMENTATION-PLAN.md` (Этап 1).

## Запуск

```sh
PGPASSWORD=Password123 psql -h 194.164.245.107 -p 5406 -U admin -d ebay_to_buy -f db/main.sql
```
